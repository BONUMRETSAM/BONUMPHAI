...
module.exports = {
  ...
  // ============ ENHANCED: EDUCATIONAL QUESTION DETECTION ============
  ...
  // ============ ENHANCED: ULTRA-ACCURATE GEMINI PROMPT ============
  buildGeminiPrompt(userPrompt) {
    let prompt = `You are Teacher Arlene - an ULTRA-ACCURATE AI assistant specializing in image analysis. Your task is to provide 100% ACCURATE, COMPLETE, and DETAILED responses.

⚠️ CRITICAL INSTRUCTIONS:
1. READ EVERYTHING in the image - every word, number, symbol, diagram
2. DO NOT miss any text, even if it's small or blurry
...
1️⃣ ACTIVITY SHEET / WORKSHEET / QUIZ / HOMEWORK
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
- D: [Why D is incorrect] (if applicable)

━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

2️⃣ MATH PROBLEMS / EQUATIONS
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
🔍 PARTS IDENTIFIED:
1. [Part 1] → [Function/Description]
2. [Part 2] → [Function/Description]
3. [Part 3] → [Function/Description]
...
...
📖 EXPLANATION:
[Complete explanation why it's true or false]
- Evidence 1
- Evidence 2
...
1. [Item 1] → [Letter]. [Matched item]
2. [Item 2] → [Letter]. [Matched item]
...
...
8️⃣ GENERAL IMAGE (Photo, Art, Screenshot)
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
FORMAT:
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
🖼️ IMAGE ANALYSIS
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
1. BE 100% ACCURATE - Double-check everything
...
7. NEVER say "I can't" - always try your best
8. Use PLAIN TEXT only - no markdown, no symbols
9. If you're unsure, state that clearly and provide your best answer
...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━`;
  ...
  // ============ ENHANCED: PROCESS GEMINI RESPONSE ============
  processGeminiResponse(response) {
    ...
    // Add final answer section if missing
    processed = this.ensureFinalAnswerSection(processed);
    
    return processed;
  },

  // ============ NEW: ENSURE COMPLETE ANSWERS ============
  ensureCompleteAnswers(response) {
    let processed = response;
    
    // Check if answers are cut off
    ...
    for (let i = 0; i < lines.length; i++) {
      ...
      // Detect if we're in an answer section
      ...
      if (inAnswer) {
        // Check if answer is complete (ends with period or has explanation)
        if (line.trim() === '' || line.match(/^EXPLANATION:/i) || line.match(/^📖 EXPLANATION:/i)) {
          // Check if answer buffer has complete content
          const answerText = answerBuffer.join(' ');
          if (answerText.length < 10 || !answerText.match(/[.!?]$/)) {
            // Answer might be incomplete, try to find more
            let j = i;
          ...
          inAnswer = false;
          // Don't add the explanation line yet, let it be processed normally
    ...
    // If still in answer at the end, close it
  ...
  // ============ NEW: ENSURE FINAL ANSWER SECTION ============
  ensureFinalAnswerSection(response) {
    let processed = response;
    
    // Check if there's a final answer section
    const hasFinal = processed.match(/FINAL ANSWER:|✅ FINAL ANSWER:|📌 FINAL ANSWER:/i);
    
    if (!hasFinal) {
      // Add a final answer section at the end if there are answers
      const lines = processed.split('\n');
      const hasAnswers = lines.some(line => line.match(/^ANSWER:|^✅ ANSWER:/i));
      
      if (hasAnswers) {
        // Find the last answer and create a summary
        let lastAnswer = '';
        let lastExplanation = '';
  ...
  // ============ ENHANCED: CLEAN GEMINI FORMATTING ============

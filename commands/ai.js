...
module.exports = {
  ...
  // ===== GEMINI API WITH CLEAN FORMATTING =====
...
USER QUESTION: ${userPrompt || 'Analyze this image'}`;
  ...
  isReturnToTopicRequest(prompt) {
    ...
    const patterns = [
      ...
      'balik tayo', 'balikan natin yung', 'balik ta sa', 'balikan nato',

...
- STAY ON TOPIC.`;
  ...
  buildLetterPrompt(prompt, detectedLanguage) {
    ...
    if (detectedLanguage === 'tagalog' || detectedLanguage === 'bisaya' || detectedLanguage === 'cebuano') {
      final += `Ikaw ay isang AI assistant na gumagawa ng PERSONALIZED na sulat o talumpati.\n\n`;
      final += `AUTOMATIKONG gumawa ng sulat batay sa hiling ng user.\n`;
      final += `HUWAG nang magtanong ng mga detalye.\n`;
      final += `Ang mga detalye na kailangan ay ilagay sa ( ) para punan ng user.\n\n`;
      final += `USER REQUEST: "${prompt}"\n\n`;
      final += `Gumawa ng isang PROPESYONAL, MALINAW, at KOMPLETONG sulat o talumpati.\n`;
      final += `Gumamit ng FORMAL na tono.\n`;
      final += `Ang sulat ay dapat nasa ${langName.toUpperCase()} na wika.\n\n`;
      final += `SUNDIN ANG PORMAT:\n\n`;
      final += `\n`;
      final += `(Pangalan Mo)\n`;
      final += `(Address Mo)\n`;
      final += `(Email Address Mo)\n`;
      final += `(Contact Number Mo)\n\n`;
      final += `(Petsa ngayon)\n\n`;
      final += `(Pangalan ng Tatanggap)\n`;
      final += `(Posisyon ng Tatanggap)\n`;
      final += `(Pangalan ng Kumpanya/Organisasyon)\n`;
      final += `(Address ng Kumpanya)\n\n`;
      final += `Mahal na (Ginoo/Ginang),\n\n`;
      final += `(Unang Talata - Pagpapakilala at posisyon na ina-apply-an)\n\n`;
      final += `(Ikalawang Talata - Edukasyon at karanasan)\n\n`;
      final += `(Ikatlong Talata - Kakayahan at mga nagawa)\n\n`;
      final += `(Ikaapat na Talata - Interes at maiaambag)\n\n`;
      final += `(Panglimang Talata - Pasasalamat at availability)\n\n`;
      final += `Lubos na gumagalang,\n`;
      final += `(Pangalan Mo)\n`;
      final += `\n\n`;
      final += `Tiyakin na KUMPLETO ang lahat ng bahagi.\n`;
      final += `TUMUGON NGAYON SA ${langName.toUpperCase()}.`;
    } else {
      final += `You are an AI assistant that creates PERSONALIZED letters or speeches.\n\n`;
      final += `AUTOMATICALLY create a letter based on the user's request.\n`;
      final += `DO NOT ask for details anymore.\n`;
      final += `Place needed details in ( ) for the user to fill in.\n\n`;
      final += `USER REQUEST: "${prompt}"\n\n`;
      final += `Create a PROFESSIONAL, CLEAR, and COMPLETE letter or speech.\n`;
      final += `Use a FORMAL tone.\n`;
      final += `The letter should be in ${langName.toUpperCase()} language.\n\n`;
      final += `FOLLOW THIS FORMAT:\n\n`;
      final += `\n`;
      final += `(Your Full Name)\n`;
      final += `(Your Complete Address)\n`;
      final += `(Your Email Address)\n`;
      final += `(Your Contact Number)\n\n`;
      final += `(Current Date)\n\n`;
      final += `(Recipient's Full Name)\n`;
      final += `(Recipient's Position)\n`;
      final += `(Company/Organization Name)\n`;
      final += `(Company Address)\n\n`;
      final += `Dear (Mr./Ms./Dr.),\n\n`;
      final += `(First Paragraph - Introduction and position applied for)\n\n`;
      final += `(Second Paragraph - Education and experience)\n\n`;
      final += `(Third Paragraph - Skills and achievements)\n\n`;
      final += `(Fourth Paragraph - Interest and what you can contribute)\n\n`;
      final += `(Fifth Paragraph - Thank you and availability)\n\n`;
      final += `Respectfully yours,\n`;
      final += `(Your Full Name)\n`;
      final += `\n\n`;
  ...
  buildLetterResponse(prompt, detectedLanguage) {
    ...
    let final = '';
    if (detectedLanguage === 'tagalog' || detectedLanguage === 'bisaya' || detectedLanguage === 'cebuano') {
      final += `Gumawa ka ng KOMPLETO at PERSONALIZED na sulat o talumpati.\n\n`;
      final += `AUTOMATIKONG gumawa ng sulat batay sa hiling ng user.\n`;
      final += `HUWAG nang magtanong ng mga detalye.\n`;
      final += `Ang mga detalye na kailangan ay ilagay sa ( ) para punan ng user.\n\n`;
      ...
      final += `Create a COMPLETE and PERSONALIZED letter or speech.\n\n`;
      final += `AUTOMATICALLY create a letter based on the user's request.\n`;
      final += `DO NOT ask for details anymore.\n`;
      final += `Place needed details in ( ) for the user to fill in.\n\n`;
  ...
  buildResumePrompt(prompt, detectedLanguage) {
    ...
    let final = '';
    if (detectedLanguage === 'tagalog' || detectedLanguage === 'bisaya' || detectedLanguage === 'cebuano') {
      final += `Ikaw ay isang AI assistant na gumagawa ng PERSONALIZED na RESUME o CV.\n\n`;
      final += `AUTOMATIKONG gumawa ng resume batay sa hiling ng user.\n`;
      final += `HUWAG nang magtanong ng mga detalye.\n`;
      final += `Ang mga detalye na kailangan ay ilagay sa ( ) para punan ng user.\n\n`;
      final += `USER REQUEST: "${prompt}"\n\n`;
      final += `Gumawa ng isang PROPESYONAL, MALINAW, at KOMPLETONG RESUME.\n`;
      final += `Gumamit ng FORMAL na tono.\n`;
      final += `Ang resume ay dapat nasa ${langName.toUpperCase()} na wika.\n\n`;
      final += `SUNDIN ANG PORMAT NG RESUME:\n\n`;
      final += `\n`;
      final += `(Pangalan Mo)\n`;
      final += `(Address Mo)\n`;
      final += `(Email Address Mo)\n`;
      final += `(Contact Number Mo)\n\n`;
      final += `OBJECTIVE:\n`;
      final += `(Isang maikling pahayag tungkol sa iyong layunin sa trabaho)\n\n`;
      final += `EDUCATIONAL BACKGROUND:\n`;
      final += `(Kurso at Paaralan, Taon ng pagtatapos)\n\n`;
      final += `WORK EXPERIENCE:\n`;
      final += `(Pangalan ng Kumpanya) - (Posisyon) - (Taon)\n`;
      final += `(Mga responsibilidad at nagawa)\n\n`;
      final += `SKILLS:\n`;
      final += `(Mga kakayahan at kasanayan)\n\n`;
      final += `ACHIEVEMENTS:\n`;
      final += `(Mga natamo at parangal)\n\n`;
      final += `REFERENCES:\n`;
      final += `(Pangalan) - (Posisyon) - (Contact Number)\n`;
      final += `\n\n`;
      final += `Tiyakin na KUMPLETO ang lahat ng bahagi.\n`;
      final += `TUMUGON NGAYON SA ${langName.toUpperCase()}.`;
    } else {
      final += `You are an AI assistant that creates PERSONALIZED RESUME or CV.\n\n`;
      final += `AUTOMATICALLY create a resume based on the user's request.\n`;
      final += `DO NOT ask for details anymore.\n`;
      final += `Place needed details in ( ) for the user to fill in.\n\n`;
      final += `USER REQUEST: "${prompt}"\n\n`;
      final += `Create a PROFESSIONAL, CLEAR, and COMPLETE RESUME.\n`;
      final += `Use a FORMAL tone.\n`;
      final += `The resume should be in ${langName.toUpperCase()} language.\n\n`;
      final += `FOLLOW THIS RESUME FORMAT:\n\n`;
      final += `\n`;
      final += `(Your Full Name)\n`;
      final += `(Your Complete Address)\n`;
      final += `(Your Email Address)\n`;
      final += `(Your Contact Number)\n\n`;
      final += `OBJECTIVE:\n`;
      final += `(A brief statement about your career goal)\n\n`;
      final += `EDUCATIONAL BACKGROUND:\n`;
      final += `(Course and School, Year Graduated)\n\n`;
      final += `WORK EXPERIENCE:\n`;
      final += `(Company Name) - (Position) - (Year)\n`;
      final += `(Responsibilities and achievements)\n\n`;
      final += `SKILLS:\n`;
      final += `(List of skills and abilities)\n\n`;
      final += `ACHIEVEMENTS:\n`;
      final += `(List of achievements and awards)\n\n`;
      final += `REFERENCES:\n`;
      final += `(Name) - (Position) - (Contact Number)\n`;
      final += `\n\n`;
      final += `Make sure ALL PARTS are COMPLETE.\n`;
      final += `RESPOND NOW IN ${langName.toUpperCase()}.`;
    }
  ...
  buildResumeResponse(prompt, detectedLanguage) {
    ...
    let final = '';
    if (detectedLanguage === 'tagalog' || detectedLanguage === 'bisaya' || detectedLanguage === 'cebuano') {
      final += `Gumawa ka ng KOMPLETO at PERSONALIZED na RESUME o CV.\n\n`;
      final += `AUTOMATIKONG gumawa ng resume batay sa hiling ng user.\n`;
      final += `HUWAG nang magtanong ng mga detalye.\n`;
      final += `Ang mga detalye na kailangan ay ilagay sa ( ) para punan ng user.\n\n`;
      final += `MGA DETALYE NG USER: "${prompt}"\n\n`;
      ...
      final += `Create a COMPLETE and PERSONALIZED RESUME or CV.\n\n`;
      final += `AUTOMATICALLY create a resume based on the user's request.\n`;
      final += `DO NOT ask for details anymore.\n`;
      final += `Place needed details in ( ) for the user to fill in.\n\n`;
      final += `USER DETAILS: "${prompt}"\n\n`;

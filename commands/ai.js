    ...
    if (lower.includes('supervisor') || lower.includes('team lead')) {
      ...
      jobExperiences = [
        ...
        },
        {
          ...
          years: '2016 – 2018',
          responsibilities: [
            'Assisted in daily store operations and provided excellent customer service to ensure a positive shopping experience',
            'Maintained accurate inventory records and processed sales transactions with high efficiency',
            'Collaborated with team members to achieve store targets and improve overall customer experience'
          ]
        }
      ];
      jobSkills = [
      ...
      jobExperiences = [
        ...
        },
        {
          ...
          years: '2018 – 2019',
          responsibilities: [
            'Assisted in transporting and organizing construction materials to support efficient workflow',
            'Performed general cleaning and maintenance of work areas to ensure a safe and organized environment',
            'Followed safety protocols and maintained a safe working environment at all times'
          ]
        }
      ];
      jobSkills = [

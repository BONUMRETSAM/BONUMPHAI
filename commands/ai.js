...
module.exports = {
  ...
  buildResumeByJob(prompt, detectedLanguage) {
    ...
    // BUILD THE COMPLETE RESUME - DIRECTLY, NO AI
    let final = '';
    ...
    final += '================================================================================\n\n';
    final += 'IMPORTANT: The user will replace the personal info in ( ) with their own details.\n';
    final += 'All other content is READY-MADE and complete for a ' + jobType.toUpperCase() + ' position.';

...
module.exports = {
  ...
  async execute(senderId, args, token, event) {
    try {
      ...
      // ----- IMAGE REQUEST (natural language) -----
      ...
      // ----- CONVERSATION CONTEXT (follow‑up / modification) -----
      ...
      if (imageUrl) {
        ...
        // Store with keywords and topic index
      ...
      // ============================================================
      //  REPLY / FOLLOW‑UP (with previous context)
      // ============================================================
        ...
        // Also store in topicHistory with keywords
  ...
  // ================================================================
  //  NEW: Content‑Based Topic Retrieval (scoring)
  // ================================================================
  ...
  // ================================================================
  //  NEW: Extract Keywords from a Response
  // ================================================================

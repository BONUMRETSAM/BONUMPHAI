...
module.exports = {
  ...
  detectLanguage(prompt) {
    ...
    // English keywords
    const englishKeywords = ['ppt', 'powerpoint', 'presentation', 'slideshow', 'slides', 'report', 'communication', 'globalization', 'academic', 'research', 'workplace', 'employment', 'digital', 'multimodal', 'public speaking', 'essay', 'plagiarism', 'resume', 'curriculum vitae', 'job interview', 'climate', 'change', 'environment', 'health', 'technology'];
    
    // Tagalog keywords
    const tagalogKeywords = ['tungkol sa', 'pag-aaral', 'epekto', 'kahalagahan'];
    ...
    // Check if contains English keywords
    ...
    // Check if contains Tagalog keywords
    ...
    // If NO Tagalog words AND has English words -> ENGLISH
    ...
    if (lower.includes('communication') || lower.includes('globalization')) {
      refs = [
        ...
        },
        {
          authors: 'Kress, G.',
          year: '2010',
          title: 'Multimodality: A Social Semiotic Approach',
          publisher: 'Routledge',
          link: 'https://scholar.google.com/scholar?q=Kress+Multimodality',
          source: 'Google Scholar',
          accessible: true,
          verified: true
        },
        {
          ...
          publisher: 'Cambridge University Press',
          link: 'https://scholar.google.com/scholar?q=Swales+Genre+Analysis',
          source: 'Google Scholar',
          accessible: true,
          verified: true
        },
